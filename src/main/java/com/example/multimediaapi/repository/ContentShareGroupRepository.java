...
public interface ContentShareGroupRepository extends JpaRepository<ContentShareGroup, Long> {
    ...
    List<ContentShareGroup> findAllByMyGroupNameAndContent_MimetypeStartingWithOrContent_UserAndContent_MimetypeStartingWith(String shareGroup_groupName, String content_mimetype, User content_user, String content_mimetype2);
